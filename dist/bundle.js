...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eatAppleGame = __webpack_require__(223);

	var _eatAppleGame2 = _interopRequireDefault(_eatAppleGame);
	...
	(0, _reactDom.render)(_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouter.Route, { path: '/', component: _eatAppleGame2.default })
		)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _detail = __webpack_require__(228);

	var _detail2 = _interopRequireDefault(_detail);

	var _btnAdd = __webpack_require__(231);

	var _btnAdd2 = _interopRequireDefault(_btnAdd);

	var _appleList = __webpack_require__(234);

	var _appleList2 = _interopRequireDefault(_appleList);
	...
	var EatAppleGame = function (_Component) {
		_inherits(EatAppleGame, _Component);

		function EatAppleGame() {
			_classCallCheck(this, EatAppleGame);

			return _possibleConstructorReturn(this, (EatAppleGame.__proto__ || Object.getPrototypeOf(EatAppleGame)).apply(this, arguments));
		}

		_createClass(EatAppleGame, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_detail2.default, { addCount: this.props.addCount, eatCount: this.props.eatCount }),
					_react2.default.createElement(_appleList2.default, { eatAppleClick: this.props.eatClick, addCount: this.props.addCount }),
					_react2.default.createElement(_btnAdd2.default, { addAppleClick: this.props.addClick })
				);
			}
		}]);
	...
	var mapDispatchToprops = function mapDispatchToprops(dispatch) {
		return (0, _redux.bindActionCreators)({
			eatClick: _action.eatApple,
			addClick: _action.addApple
		}, dispatch);
	};

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToprops)(EatAppleGame);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BtnAdd = function (_Component) {
		_inherits(BtnAdd, _Component);

		function BtnAdd() {
			_classCallCheck(this, BtnAdd);

			return _possibleConstructorReturn(this, (BtnAdd.__proto__ || Object.getPrototypeOf(BtnAdd)).apply(this, arguments));
		}
		...
		_createClass(BtnAdd, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'button',
					{ className: 'btn-add', onClick: this.props.addAppleClick },
					'\u65B0\u589E'
				);
			}
		}]);
	...
	exports.default = BtnAdd;


	BtnAdd.PropTypes = {
		addAppleClick: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppleList = function (_Component) {
		_inherits(AppleList, _Component);

		function AppleList() {
			_classCallCheck(this, AppleList);

			return _possibleConstructorReturn(this, (AppleList.__proto__ || Object.getPrototypeOf(AppleList)).apply(this, arguments));
		}

		_createClass(AppleList, [{
			key: 'render',
			value: function render() {
				var appleList = [];
				for (var i = 0; i < this.props.addCount; i++) {
					appleList.push(_react2.default.createElement(Apple, { key: i, eatAppleClick: this.props.eatAppleClick }));
				}
				return _react2.default.createElement(
					'ul',
					{ className: 'appleList' },
	...
	exports.default = AppleList;

	AppleList.PropTypes = {
		appleCount: _react.PropTypes.number.isRequired,
		eating: _react.PropTypes.func.isRequired
	};

	var Apple = function (_Component2) {
		_inherits(Apple, _Component2);
		...
		_createClass(Apple, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ onClick: this.props.eatAppleClick },
						'\u5403\u6389'
					)
				);
			}
...
/***/ function(module, exports) {
	...
	exports.eatApple = eatApple;
	exports.addApple = addApple;
	var EAT_APPLE = exports.EAT_APPLE = 'EAT_APPLE';
	var ADD_APPLE = exports.ADD_APPLE = 'ADD_APPLE';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _connectAdvanced = __webpack_require__(242);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapStateToProps = __webpack_require__(272);

	var _mapStateToProps2 = _interopRequireDefault(_mapStateToProps);

	var _mergeProps = __webpack_require__(273);

	var _mergeProps2 = _interopRequireDefault(_mergeProps);

	var _selectorFactory = __webpack_require__(274);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wrapMapToProps = __webpack_require__(270);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _verifyPlainObject = __webpack_require__(271);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _verifySubselectors = __webpack_require__(275);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setAppleCountApp = (0, _redux.combineReducers)({
	    setAppleCount: _reducers.setAppleCount
	});

	var store = exports.store = (0, _redux.createStore)(setAppleCountApp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.setAppleCount = undefined;

	var _action = __webpack_require__(237);

	var setAppleCount = exports.setAppleCount = function setAppleCount() {
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { eatCount: 0, addCount: 0 };
		var action = arguments[1];

		switch (action.type) {
			case _action.EAT_APPLE:
				return {
					eatCount: state.eatCount + 1,
					addCount: state.addCount - 1
				};
			case _action.ADD_APPLE:
				return {
					addCount: state.addCount + 1,
